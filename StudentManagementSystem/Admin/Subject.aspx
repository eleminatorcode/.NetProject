<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Subject.aspx.cs" Inherits="StudentManagementSystem.Admin.WebForm1" %>
     ...
     <div class="container p-md-4 p-sm-4">
         ...
         <div class="row mb-3 mr-lg-2 ml-lg-2 mt-md-3">
             <div class="col-md-1 col-md-offset-10 mb-3">
                 <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#5558c" Text="Add Subject"  Width="223px" OnClick="btnAdd_Click" />
             </div>
         </div>
         <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
             <div class="col-md-6">
                 <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" DataKeyNames="SubjectId" EmptyDataText="No record to display!" 
                     ...
                     <Columns>
                         ...
                         <asp:TemplateField HeaderText="Subject">
                             <EditItemTemplate>
                                 <asp:TextBox ID="TextBoxSub" runat="server" Text='<%# Eval("SubjectName") %>' CssClass="form-control"></asp:TextBox>
                             </EditItemTemplate>
                             <ItemTemplate>
